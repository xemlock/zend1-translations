...
return array(
    ...
    "Luhn algorithm (mod-10 checksum) failed on '%value%'" => "Luhn algorithm (mod-10 checksum) failed on the value",
    ...
    "An exception has been raised while validating '%value%'" => "An exception has been raised while validating the value",
    ...
    "'%value%' does not fit the date format '%format%'" => "Value does not fit the expected date format",

    // Zend_Validate_Db_Abstract
    "No record matching '%value%' was found" => "No record matching given value was found",
    "A record matching '%value%' was found" => "A record matching given value was found",
    ...
    "'%hostname%' is not a valid hostname for email address '%value%'" => "Invalid hostname for given email address",
    "'%hostname%' does not appear to have a valid MX record for the email address '%value%'" => "Hostname does not appear to have a valid MX record for given email address",
    "'%hostname%' is not in a routable network segment. The given email address should not be resolved from public network" => "Hostname is not in a routable network segment. The given email address should not be resolved from public network",
    "'%localPart%' can not be matched against dot-atom format" => "Local part cannot be matched against dot-atom format",
    "'%localPart%' can not be matched against quoted-string format" => "Local part cannot be matched against quoted-string format",
    "'%localPart%' is not a valid local part for email address '%value%'" => "Invalid local part for given email address",
    ...
    "File '%value%' does not match the given crc32 hashes" => "File does not match the given CRC32 hashes",
    "A crc32 hash could not be evaluated for the given file" => "A CRC32 hash could not be evaluated for the given file",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_ExcludeExtension
    "File '%value%' has a false extension" => "File has a false extension",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_ExcludeMimeType
    "File '%value%' has a false mimetype of '%type%'" => "File has a false mimetype of '%type%'",
    "The mimetype of file '%value%' could not be detected" => "The mimetype of the file could not be detected",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_Exists
    "File '%value%' does not exist" => "File does not exist",
    ...
    "File '%value%' does not match the given hashes" => "File does not match the given hashes",
    "A hash could not be evaluated for the given file" => "A hash could not be evaluated for the given file",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_ImageSize
    "Maximum allowed width for image '%value%' should be '%maxwidth%' but '%width%' detected" => "Maximum allowed width for image should be '%maxwidth%' but '%width%' detected",
    "Minimum expected width for image '%value%' should be '%minwidth%' but '%width%' detected" => "Minimum expected width for image should be '%minwidth%' but '%width%' detected",
    "Maximum allowed height for image '%value%' should be '%maxheight%' but '%height%' detected" => "Maximum allowed height for image should be '%maxheight%' but '%height%' detected",
    "Minimum expected height for image '%value%' should be '%minheight%' but '%height%' detected" => "Minimum expected height for image should be '%minheight%' but '%height%' detected",
    "The size of image '%value%' could not be detected" => "The size of image could not be detected",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_IsCompressed
    "File '%value%' is not compressed, '%type%' detected" => "File is not compressed, '%type%' detected",
    "The mimetype of file '%value%' could not be detected" => "The mimetype of the file could not be detected",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_IsImage
    "File '%value%' is no image, '%type%' detected" => "File is no image, '%type%' detected",
    "The mimetype of file '%value%' could not be detected" => "The mimetype of the file could not be detected",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_Md5
    "File '%value%' does not match the given md5 hashes" => "File does not match the given MD5 hashes",
    "A md5 hash could not be evaluated for the given file" => "An MD5 hash could not be evaluated for the given file",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",
    ...
    "File '%value%' exists" => "File exists",

    // Zend_Validate_File_Sha1
    "File '%value%' does not match the given sha1 hashes" => "File does not match the given SHA-1 hashes",
    "A sha1 hash could not be evaluated for the given file" => "A SHA-1 hash could not be evaluated for the given file",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_Size
    "Maximum allowed size for file '%value%' is '%max%' but '%size%' detected" => "Maximum allowed size for file is '%max%' but '%size%' detected",
    "Minimum expected size for file '%value%' is '%min%' but '%size%' detected" => "Minimum expected size for file is '%min%' but '%size%' detected",
    "File '%value%' is not readable or does not exist" => "File is not readable or does not exist",

    // Zend_Validate_File_Upload
    "File '%value%' exceeds the defined ini size" => "File exceeds the defined ini size",
    "File '%value%' exceeds the defined form size" => "File exceeds the defined form size",
    "File '%value%' was only partially uploaded" => "File was only partially uploaded",
    "File '%value%' was not uploaded" => "File was not uploaded",
    "No temporary directory was found for file '%value%'" => "No temporary directory was found for the file",
    "File '%value%' can't be written" => "File can't be written",
    "A PHP extension returned an error while uploading the file '%value%'" => "A PHP extension returned an error while uploading the file",
    "File '%value%' was illegally uploaded. This could be a possible attack" => "File was illegally uploaded. This could be a possible attack",
    "File '%value%' was not found" => "File was not found",
    "Unknown error while uploading file '%value%'" => "Unknown error while uploading the file",
    ...
    // Zend_Validate_Regex
    "Invalid type given. String, integer or float expected" => "Invalid type given. String, integer or float expected",
    "'%value%' does not match against pattern '%pattern%'" => "Value does not match against the pattern",
    "There was an internal error while using the pattern '%pattern%'" => "There was an internal error while using the pattern",
